...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth]{iterconv.jpeg}
  \caption{The plot compares the optimization efficiency of $L_2$-regularized Burer-Monteiro factorization against explicit nuclear norm (NUC) regularization.}
