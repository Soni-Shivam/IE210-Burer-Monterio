...
\subsubsection{Experimental Setup}
We construct a matrix completion task. A ground-truth matrix $M_{\text{true}}
...
\subsubsection{Results}
The experimental results show that Model B (large init) trivially fits the observed entries but fails
...
We swept the success-rate threshold $\varepsilon \in
...
Sweeping the Softmax temperature $\tau \in
